...
if (!nexacro._CellControl) {
	...
	_pCellControl._updateAll = function (status, onlycontents, nochk_updatearea) {
		if (this.__update(status, onlycontents, nochk_updatearea)) {
			...
			if (control_elem) {
				...
				if (!onlycontents) {
					this._control_element.setElementBorderNone(remove_l, remove_t, remove_r, remove_b, nexacro._toBoolean(this._view ? this._view.rtl : this.rtl));
				}
	...
	_pCellControl._updateAllEx = function (prop) {
		...
		if (control_elem) {
			...
			this._control_element.setElementBorderNone(remove_l, remove_t, remove_r, remove_b, nexacro._toBoolean(this._view.rtl));
		}
		return true;
	};
	...
	_pCellTextArea._getComputedStyle = function () {
		...
		if (this.hscrollbar) {
			...
			new Function("ctrl_cs", "str", "ctrl_cs.hscrollbar.incbutton.styles = str")(ctrl_cs, str);
			ctrl_cs.styles = (new Function("return " + str))();
	...
	_pCellCalendar._on_drop_mobile_onclick = function (obj, e) {
	...
	_pCellCalendar._on_dataset_onrowsetchanged = function (obj, e) {
		...
		else if (e.reason != nexacro.NormalDataset.REASON_FILTER && e.reason != nexacro.NormalDataset.REASON_SORTGROUP) {
	...
	_pCellCombo._on_edit_mobile_oneditclick = function (obj, e) {
	...
	_pCellCombo._on_drop_mobile_onclick = function (obj, e) {
