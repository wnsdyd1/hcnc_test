...
if (!nexacro.Device || nexacro._OS == "Windows" || nexacro._OS == "Android" || nexacro._OS == "OSX") {
	...
	if (!nexacro.LiteDBConnection) {
		...
		_pLiteDBConnection.open = function (strDataSource, constOpenFlag) {
			...
			if (this.paramck_open(this.datasource, constOpenFlag)) {
				nexacro._openLiteDBConnectionHandle(this, this.datasource, constOpenFlag);
			}
			else {
				return false;
			}
