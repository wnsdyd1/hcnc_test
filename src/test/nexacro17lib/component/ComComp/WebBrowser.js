	...
	_pWebBrowser._apply_setfocus = function (evt_name) {
		...
		if (ifrm_elem) {
			if (nexacro._enableaccessibility) {
				if (evt_name == "downkey" || evt_name == "tabkey") {
					ifrm_elem._setElementForwardFocus(this._getAccessibilityReadLabel(), this.accessibilityleavemessage);
				}
				else if (evt_name == "upkey" || evt_name == "shifttabkey") {
					ifrm_elem._setElementBackwardFocus(this._getAccessibilityReadLabel(), this.accessibilityleavemessage);
				}
			}
			else {
